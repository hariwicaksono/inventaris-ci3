						...
						<form id="input_form" action="<?php echo base_url('inventory/add') ?>" method="post" autocomplete="off" class="form form-horizontal" enctype="multipart/form-data">
								...
								$id = sprintf('%s', $nextNoUrut);?>
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="code" id="code" class="form-control required" value="<?=$id?>" required>
										</div>
									</div>
									<div class="form-group">
													...
													foreach ($cat_list->result() as $cls2):
														...
														<div class="radio">
															<label for="category2_<?php echo $cls2->id; ?>">
																<input type="radio" name="category2" id="category2_<?php echo $cls2->id; ?>" value="<?php echo $cls2->id; ?>" <?php if($xs==1){echo "checked";} ?>>
																<?php echo $cls2->name ?>
															</label>
														</div>
													...
													foreach ($stat_list->result() as $sls2):
														...
														<div class="radio">
															<label for="status2_<?php echo $sls2->id; ?>">
																<input type="radio" name="status2" id="status2_<?php echo $sls2->id; ?>" value="<?php echo $sls2->id; ?>" <?php if($xs==1){echo "checked";} ?>>
																<?php echo $sls2->name ?>
															</label>
														</div>
													<?php endforeach; echo "</div>"; ?>
